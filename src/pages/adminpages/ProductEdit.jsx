...
export default function ProductEdit() {
  ...
  const { updateProduct, getProductById } = useProducts(); //mengosongkan state formData dan errors
    ...
    >
      ...
      <div className="flex flex-col">
        ...
        <textarea
          ...
          rows="3"
          className="border border-gray-300 rounded-lg p-2 focus:outline-nonefocus:ring-2 focus:ring-blue-400 resize-none"
        />
      </div>
      <div className="flex flex-col">
      ...
      <div className="flex flex-col">
        ...
        <input
          ...
          accept="image/*"
          onChange={handleChange}
          className="border border-gray-300 rounded-lg p-2 bg-gray-50 file:mr-4file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-blue-100 file:text-blue-600 hover:file:bg-blue-200"
        />
        {errors.img && (
      ...
      <button
        type="submit"
        className="w-full cursor-pointer bg-blue-600 hover:bg-blue-700 text-whitefont-semibold py-2 rounded-lg transition duration-200"
      >
        Simpan Produk
      </button>
    </form>
